...
7. **Domain Research** — conditional, only when step 6's Aesthetic Boldness criterion answered *Trend-forward* or *Experimental/bold*, or another answer explicitly invoked current real-world trends; *Brand-centric* and *Functional/minimalist* skip straight to step 8:
